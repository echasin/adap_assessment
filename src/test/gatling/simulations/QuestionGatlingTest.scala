...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .post("/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "question":"SAMPLE_TEXT", "mandatory":null, "code":"SAMPLE_TEXT", "position":"0", "status":"SAMPLE_TEXT", "lastmodifiedby":"SAMPLE_TEXT", "lastmodifieddatetime":"2020-01-01T00:00:00.000Z", "domain":"SAMPLE_TEXT", "type":"SAMPLE_TEXT", "help":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
