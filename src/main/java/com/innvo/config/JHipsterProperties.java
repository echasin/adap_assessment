...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_assessment@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_assessment API";

        private String description = "adap_assessment API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_assessment";
