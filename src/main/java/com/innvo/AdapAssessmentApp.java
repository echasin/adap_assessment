...
@EnableEurekaClient
public class AdapAssessmentApp {

    private static final Logger log = LoggerFactory.getLogger(AdapAssessmentApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes adap_assessment.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AdapAssessmentApp.class);
